...
- Verify by the cart displayed correct amount and quantity and product
- Verify by correct total amount is displayed if the user added multiple products to the cart
